...
export class CreateWalletTables1762294800000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const companyWalletsTableExists =
      await queryRunner.hasTable('company_wallets');
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    if (companyWalletsTable) {
      ...
      if (companyFk)
        await queryRunner.dropForeignKey('company_wallets', companyFk);
      if (parentWalletFk)
        await queryRunner.dropForeignKey('company_wallets', parentWalletFk);
    }

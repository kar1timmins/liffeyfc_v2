...
export interface EscrowFactoryUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allEscrows"
      | "companyEscrows"
...
export interface EscrowFactoryUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): EscrowFactoryUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: EscrowFactoryUpgradeableInterface;

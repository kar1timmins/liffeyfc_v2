		...
		>
			<div class="card-body">
				...
				<div class="card-actions">
					...
					>
						<span
							class=" bg-base-100 text-gray-800 group-hover:text-gray-100 dark:bg-base-300 dark:text-gray-800 rounded-lg relative px-4 py-2.5 leading-5 transition-all duration-75 ease-in group-hover:bg-transparent group-hover:dark:bg-transparent"
						>
							View Companies
						</span>
					</button>

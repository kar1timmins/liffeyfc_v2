import"../chunks/DsnmJJEf.js";import{i as x}from"../chunks/DRW1BwqY.js";import{p as C,c as L,h as _,f as P,a as n,b as F,w as D,$ as j,d,n as p,g as A,m as k,e as o,s as l,r,i as m,j as E}from"../chunks/CiTonTpy.js";import{i as S}from"../chunks/CmVn1BOI.js";import{t as W}from"../chunks/B0A7PhA6.js";import{g as I}from"../chunks/3VJitbvB.js";import{r as O}from"../chunks/C9OA-y7O.js";var Q=D(d(`<meta name="description" content="Join Dublin's premier startup community. Practice your pitch, connect with investors, and grow your business. Quarterly events for entrepreneurs in Dublin, Ireland."/> <link rel="canonical" href="https://liffeyfoundersclub.com/"/> <meta name="robots" content="index, follow"/> <meta property="og:type" content="website"/> <meta property="og:url" content="https://liffeyfoundersclub.com/"/> <meta property="og:title" content="Liffey Founders Club - Practice What You Pitch"/> <meta property="og:description" content="Join Dublin's premier startup community. Practice your pitch, connect with investors, and grow your business."/> <meta property="og:image" content="https://liffeyfoundersclub.com/img/logo/Liffey_Founders_Club_Logo.png"/> <meta property="og:image:type" content="image/png"/> <meta property="og:image:width" content="1668"/> <meta property="og:image:height" content="2388"/> <meta property="og:image:alt" content="Liffey Founders Club Logo"/> <meta property="twitter:card" content="summary"/> <meta property="twitter:url" content="https://liffeyfoundersclub.com/"/> <meta property="twitter:title" content="Liffey Founders Club - Practice What You Pitch"/> <meta property="twitter:description" content="Join Dublin's premier startup community. Practice your pitch, connect with investors, and grow your business."/> <meta property="twitter:image" content="https://liffeyfoundersclub.com/img/logo/Liffey_Founders_Club_Logo.png"/> <meta property="twitter:image:alt" content="Liffey Founders Club Logo"/> <script type="application/ld+json">
  ...
  <\/script>`,1)),M=d('<section class="relative min-h-screen w-full overflow-hidden flex items-center justify-center bg-black text-white -mt-20 sm:-mt-24 md:-mt-28"><video autoplay loop class="absolute w-full h-full object-cover object-center opacity-40 top-0"><source src="/videos/encoded_2_1.webm" type="video/webm"/> <source src="/videos/encoded_2.mp4" type="video/mp4"/></video> <div class="relative z-10 text-center px-4 flex flex-col items-center pt-20 sm:pt-24 md:pt-0"><div class="glass-homepage rounded-3xl px-4 py-6 sm:px-6 sm:py-6 md:px-10 md:py-8 backdrop-blur-md max-w-4xl w-full"><div class="mb-4 flex justify-center"><img src="/img/logo/Liffey_Founders_Club_Logo.png" alt="Liffey Founders Club Logo" class="h-40 sm:h-48 md:h-60 w-auto object-contain"/></div> <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold animate-fade">Practice What You Pitch</h1> <h2 class="mt-3 sm:mt-4 text-base sm:text-lg md:text-xl max-w-xl mx-auto px-2">Capture attention, showcase your vision, and connect with investors.</h2> <button type="button" class="btn btn-primary btn-neon mt-6 sm:mt-8 px-6 sm:px-8 py-2 sm:py-3 rounded-full text-base sm:text-lg font-semibold flex items-center gap-2 transition-transform transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-primary/50 mx-auto">Start Now</button> <div class="mt-4 sm:mt-6 flex flex-wrap justify-center gap-3 sm:gap-4 text-xs sm:text-sm opacity-80"><a href="/pitch" class="hover:text-primary transition-colors">View Pitches</a> <span>•</span> <a href="/learnMore" class="hover:text-primary transition-colors">Join Community</a></div></div></div></section>',2);function B(f,y){C(y,!1);let i=k(!0);function h(e){e.preventDefault(),E(i,!1)}function g(){I("/pitch")}x();var s=L();_(e=>{var t=Q();j.title="Liffey Founders Club - Practice What You Pitch | Startup Community Dublin",p(40),n(e,t)});var b=P(s);{var v=e=>{var t=M(),a=o(t);a.muted=!0;var c=l(a,2),u=o(c),w=l(o(u),6);p(2),r(u),r(c),r(t),m("click",w,h),W(2,t,()=>O),m("outroend",t,g),n(e,t)};S(b,e=>{A(i)&&e(v)})}n(f,s),F()}export{B as component};
